...
public class MainUtamaBaruForm extends javax.swing.JFrame {
    
    private JLabel lbTime;
    private JLabel lbDate;

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(MainUtamaBaruForm.class.getName());

    /**
     * Creates new form MainUtamaBaruForm
     */
    public MainUtamaBaruForm() {
        initComponents(); // ini milik NetBeans
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new MainUtamaBaruForm().setVisible(true));
    }
